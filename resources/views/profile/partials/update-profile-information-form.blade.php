    ...
    @elseif(Auth::guard('pelanggan')->check())
        <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
            ...
            <div>
                ...
                <x-text-input id="nama_pelanggan" name="nama_pelanggan" type="text" class="mt-1 block w-full" :value="old('nama_pelanggan', $user->nama_pelanggan)" required autofocus />
            ...
            <div>
                ...
                <x-text-input id="no_telpon" name="no_telpon" type="text" class="mt-1 block w-full" :value="old('no_telpon', $user->no_telpon)" />

    ...
    <div class="bg-white p-6 rounded shadow max-w-md mx-auto">
        ...
        <form action="{{ route('satuan.update', $satuan->id_satuan) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama_satuan" value="{{ old('nama_satuan', $satuan->nama_satuan) }}" class="w-full border p-2 rounded @error('nama_satuan') border-red-500 bg-red-50 @enderror">
